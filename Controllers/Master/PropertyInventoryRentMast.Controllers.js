...
exports.property_inventory_rent_mast_fill = async (req, res) => {
  ...
  await form(req, res, async (err) => {
    ...
    try {
      connection.query(
        "call sp_property_inventory_rent_mast_fill(?,?)",
...
exports.property_inventory_rent_mast_save = async (req, res) => {
  ...
  await cpUpload(req, res, async (err) => {
    ...
    try {
      if (in_p_title == "") {
        ...
        connection.query(
          "call sp_property_inventory_rent_mast_save(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
          [
...
exports.property_inventory_rent_mast_delete = async (req, res) => {
  var form = multer().array([]);
  await form(req, res, async (err) => {
    let in_property_inventory_id = req.body.property_inventory_id;
    const userId = req.user;
    ...
    try {
      if (!in_property_inventory_id) {
        ...
        connection.query(
          "call sp_property_inventory_rent_mast_delete(?,?)",
